...
const (
	...
	clientProperties = `
      ...
      ssl.truststore.location=/etc/kafka-certs/server_ca_bundle.jks
      ssl.truststore.password=server_ca_bundle
    `
	...
	serverProperties = `
      ...
      ssl.keystore.location=/etc/kafka-certs/server.pkcs12
